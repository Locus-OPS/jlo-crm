...
@Component({
  ...
  imports: [SharedModule, TreeComponent, KbDetailComponent, KbDetailInfoComponent, RatingComponent, FavoriteComponent, KbDetailDocumentComponent, KbDetailKeywordComponent, KbDetailSearchBykeywordComponent],
