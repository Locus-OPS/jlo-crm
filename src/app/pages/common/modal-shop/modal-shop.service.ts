...
export class ModalShopService {
  ...
  getModalShopList(param: ApiPageRequest<any>): Promise<ApiPageResponse<any>> {
    return this.api.call('/api/modal/searchShopPopup', param);
  }
}
